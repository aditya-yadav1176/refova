...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DjuZtXY4.mjs");
...
var manifest = { "5654329e34be191256640c8957e4eaed33fcb574dfccb4b513f44c828b16863f": {
	...
	importer: () => import("./origin.functions-CaJhkdXT.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BOn4884-.mjs").then((n) => n.t),
		import("./start-C3Td48FJ.mjs"),
...
//#endregion
export { TSS_SERVER_FUNCTION as a, __exportAll as c, createServerFn as i, createCsrfMiddleware as n, getServerFnById as o, createMiddleware as r, getRequest as s, server_exports as t };
