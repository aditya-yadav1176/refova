...
import { _ as useAuth, a as Route$5, g as deriveUsername } from "./router-BOn4884-.mjs";
import { C as EyeOff, F as ArrowLeft, S as Eye, _ as LogIn } from "../_libs/lucide-react.mjs";
import { r as cn, t as SiteHeader } from "./site-header-mE72LyKf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-B0iSwrSl.js
...
function LoginPage() {
	...
	const handleForgotPassword = async () => {
		...
		try {
			...
			toast("Password reset email sent", { description: `Check your inbox at ${email}.` });
		} catch {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								...
								children: "Log in to discover, save and share referrals."
							})]
						}),
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-block size-4 animate-spin rounded-full border-2 border-primary-foreground/30 border-t-primary-foreground" }), "Logging in…"]
									}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "flex items-center justify-center gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogIn, { className: "size-4" }), "Log in"]
									})
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "bg-card px-3 text-xs font-medium text-muted-foreground",
