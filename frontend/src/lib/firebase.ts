...
const projectId =
  (import.meta.env["VITE_FIREBASE_PROJECT_ID"] as string | undefined)?.trim() || "refova-f44cb";
...
const firebaseConfig = {
  ...
  messagingSenderId:
    (import.meta.env["VITE_FIREBASE_MESSAGING_SENDER_ID"] as string | undefined) || "123456789012",
  appId:
    (import.meta.env["VITE_FIREBASE_APP_ID"] as string | undefined) || "1:123456789012:web:dummy",
};
